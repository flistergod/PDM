...
public class ListView_campanhas_todas extends ArrayAdapter<String> {
    //variaveis
    ...
    public ListView_campanhas_todas(Activity context, String[] campanha_titulo, String[] empresaname) {
        super(context, R.layout.lv_campanhas_todas,campanha_titulo);
